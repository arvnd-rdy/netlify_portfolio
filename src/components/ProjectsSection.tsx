...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="h-screen bg-white relative z-10 scroll-mt-28 overflow-hidden" ref={containerRef}>
      <div className="h-full overflow-y-auto">
        <motion.div 
          className="container mx-auto max-w-6xl px-8 w-full py-16" 
          ref={ref}
          initial="hidden"
